...
return (
  ...
  <>
    ...
    <section className='flex justify-center items-center mt-10'>
      <form className='max-w-sm h-full shadow-2xl bg-teal-700/40 p-6 rounded-xl'
        onSubmit={(e) => {
          e.preventDefault();//stop to reload form 
          SubmitForm();
        }}
      >
        <h1 className='text-center py-4 text-3xl font-semibold text-teal-500'>Log In </h1>
        {/* {email} */}
        ...
        {/* {Submit button} */}
          ...
          <input className="w-full text-center bg-teal-500 text-teal-700 px-4 py-2 rounded-md font-semibold text-xl"
          type="submit" 
          value="Login" />
