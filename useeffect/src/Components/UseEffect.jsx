    ...
    return (
        <>
            ...
            <section className="flex items-center justify-between p-6">
                <button className="bg-orange-400 text-white py-2 px-4 font-bold rounded-md
        active:bg-orange-100 active:scale:95 active:text-orange-400" onClick={() => {
                        setIndex(index - 1);
                    }}>Prev
                </button>
                ...
                <div
                    className="max-w-5xl mx-auto bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col lg:flex-row mt-10"
                >
